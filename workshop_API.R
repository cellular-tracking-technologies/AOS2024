...
################
get_my_data(my_token, outpath, con, myproject=myproject, begin=as.Date("2023-09-01"), end=as.Date("2023-09-30"), filetypes=c("raw", "node_health"))
